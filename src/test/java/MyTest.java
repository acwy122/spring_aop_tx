...
//        System.out.println(zhangsan);
    ...
    public void test04(){
        ...
        int result = jdbcTemplate.update(sql, 1111);
    ...
    public void test05(){
        ...
        int result = jdbcTemplate.update(sql, "mashibing",2222);
        System.out.println(result);
    }
...
//        }
        Emp result = jdbcTemplate.queryForObject(sql, new BeanPropertyRowMapper<>(Emp.class),2222);
        System.out.println(result);
    }
    ...
    public void test07(){
        JdbcTemplate jdbcTemplate = context.getBean("jdbcTemplate", JdbcTemplate.class);
        String sql = "select * from emp where empno > ?";
        List<Emp> result = jdbcTemplate.query(sql, new BeanPropertyRowMapper<>(Emp.class),0);
        for (Emp emp : result) {
            System.out.println(emp);
        }
    }
